...
# from jobsearch_agent.agents.cv_writer import call_cv_agent
...
from jobsearch_agent.utils.file_utils import slugify, ensure_dir_exists
...
#     try:
#         from jobsearch_agent.utils.document_database import DocumentDatabase
#
#         db = DocumentDatabase()
...
async def match_cv_to_jobs(
    ...
    async def _run():
        try:
            from jobsearch_agent.utils.cv_match_pipeline import run_cv_match
...
if __name__ == "__main__":
    ...
    uvicorn.run("jobsearch_agent.api.app:app", host="127.0.0.1", port=8000, reload=True)
