...
python -m jobsearch_agent.scraper.search.linkedin_scraper "Python Developer" "Berlin"

# With filters and options
python -m jobsearch_agent.scraper.search.linkedin_scraper "Data Scientist" "New York" \
...
python -m jobsearch_agent.scraper.search.linkedin_scraper "Software Engineer" "Remote" \
  --browser firefox \
...
python -m jobsearch_agent.scraper.search.linkedin_scraper \
...
**Synchronous Usage:**
```python
from jobsearch_agent.scraper.search.linkedin_scraper import LinkedInScraperSync
...
```bash
# With proxy
python -m jobsearch_agent.scraper.search.linkedin_scraper "Software Engineer" "Remote" --proxy http://proxy:8080

# Disable anonymization
python -m jobsearch_agent.scraper.search.linkedin_scraper "Data Scientist" "NYC" --no-anonymize

# Firefox with SOCKS5 proxy
python -m jobsearch_agent.scraper.search.linkedin_scraper "Python Dev" "Berlin" --browser firefox --proxy socks5://proxy:1080
```
...
**Migration steps:**
1. Replace import: `from jobsearch_agent.scraper.search.linkedin_scraper import LinkedInScraper`
